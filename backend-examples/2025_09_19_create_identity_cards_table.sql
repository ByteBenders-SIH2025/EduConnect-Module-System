-- Migration: Create Identity Cards Table for EduConnect
-- Date: 2025-09-19
-- Description: Creates the identity_cards table and related objects for the Identity Card module

-- Create the main identity_cards table
